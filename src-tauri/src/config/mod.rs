...
pub use connection::{
    ...
    SftpSettings, SshAgentEndpoint, SshAlgorithmMode, SshAlgorithmPreferences,
    TelnetAutoLoginConfig, load_config, load_connection_by_id, load_sessions,
    resolve_connection_encoding, save_config, save_sessions,
};
#[allow(unused_imports)]
pub use credential::{
