...
pub use connection::{
    ...
    TelnetAutoLoginConfig, effective_cwd_follow_mode, effective_cwd_follow_mode_for_profile,
    load_config, load_connection_by_id, load_sessions, resolve_connection_encoding,
    resolve_ssh_terminal_type, save_config, save_sessions,
};
#[allow(unused_imports)]
pub use credential::{
